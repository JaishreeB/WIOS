...
public class CustomGlobalExceptionHandler {
	...
	@ExceptionHandler(value = TransactionLogNotFound.class)
	public ResponseEntity<ExceptionResponse> handleAdminRegistrationException(TransactionLogNotFound exception,
